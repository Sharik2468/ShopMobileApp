...
namespace InternetShopWebApp.Controllers
{
    ...
    public class OrderItemController : ControllerBase
    {
        ...
        public OrderItemController(OrderServices newOrderService, ILogger<ProductController> logger)
        {
        ...
        // GET: api/OrderItems
        [HttpGet]
        public ActionResult<IEnumerable<OrderItemTable>> GetAllOrderItem()
        {
            //return _orderService.GetAllOrderItemService();
            var orderItems = _orderService.GetAllOrderItemService();
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<List<OrderItemTable>>> GetOrderItem(int id)
        {
        ...
        public async Task<ActionResult<IEnumerable<OrderItemTable>>> NewOrderItem(string Request)
        {
